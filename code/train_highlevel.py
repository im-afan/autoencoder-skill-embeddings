...
sys.argv = ["python", "--algo", "ppo", "--env", "AntObstacleHighLevel-v0", "--eval-freq", "100000", "--tensorboard-log", "/tmp/stable-baselines3", "-i", "logs/ppo/AntObstacleHighLevel-v0_4/AntObstacleHighLevel-v0.zip", "-P"]
